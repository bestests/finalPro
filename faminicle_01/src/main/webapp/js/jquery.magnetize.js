(function($) {
	...
	$.fn.magnetize = function(options) { 
		var settings = {  
				...
				fixed_width: 750, // slideshow viewport width
				fixed_height : 550, // slideshow viewport height
...
//		}
		...
		function createContainers(planes) {
			var CanvasArray = '<div class="close"></div><div class="dark-layer l2"></div><div class="dark-layer l1"></div><div class="img-caption"><p></p></div><div class="navig"></div>',
				corner;
			for (var k=0; k < length; k++) {
